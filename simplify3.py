...
train_data_s=np.zeros((60000, 225))
test_data_s=np.zeros((10000, 225))

train_data_s=train_data_s.reshape(60000, 15, 15)
test_data_s=test_data_s.reshape(10000, 15, 15)
...
for num in range(60000):
	for i in range(15):
		for j in range(15):
			train_data_s[num][i][j]=center(train_data[num], 3*i, 3*j)

for num in range(10000):
	for i in range(15):
		for j in range(15):
			test_data_s[num][i][j]=center(test_data[num], 3*i, 3*j)
'''
for num in range(60000):
	for i in range(22):
...
'''
train_data_s=train_data_s.reshape(60000, 225)
test_data_s=test_data_s.reshape(10000, 225)

np.save('mnist_train_s/mnist_train_data_s3', train_data_s)
np.save('mnist_test_s/mnist_test_data_s3', test_data_s)
